...
function useGlobalwarmingAPI(options) {
  const data = Object(runtime["d" /* ref */])(null);
  const error = Object(runtime["d" /* ref */])(null);
  const isPending = Object(runtime["d" /* ref */])(false);

  const fetchWarmingData = async () => {
    isPending.value = true;
    data.value = null;
    error.value = null;
    await Globalwarming[options.service]().then(res => {
      data.value = res.data;
...
var add = __webpack_require__(5).default
module.exports.__inject__ = function (context) {
  add("4249c355", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_NitrousoxidePage_vue_vue_type_style_index_0_id_24c4718f_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(160);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_NitrousoxidePage_vue_vue_type_style_index_0_id_24c4718f_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_NitrousoxidePage_vue_vue_type_style_index_0_id_24c4718f_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_NitrousoxidePage_vue_vue_type_style_index_0_id_24c4718f_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_NitrousoxidePage_vue_vue_type_style_index_0_id_24c4718f_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".child-page[data-v-24c4718f]{width:1200px;padding:20px;border-radius:10px;margin-bottom:30px}.description[data-v-24c4718f]{padding:20px;font-size:20px;color:#fff}.description ul[data-v-24c4718f]{padding-left:20px}.graphic[data-v-24c4718f]{margin-bottom:20px}.graphic__hidden[data-v-24c4718f]{height:0;overflow:hidden}@media screen and (max-width:1199px)and (min-width:768px){.child-page[data-v-24c4718f]{max-width:700px}}@media screen and (max-width:767px)and (min-width:576px){.child-page[data-v-24c4718f]{max-width:560px}}@media screen and (max-width:575px){.child-page[data-v-24c4718f]{max-width:400px}}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--3-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/index/NitrousoxidePage.vue?vue&type=template&id=24c4718f&scoped=true&
var render = function render() {
  var _vm = this,
      _c = _vm._self._c;
  ...
  }) : _vm._e(), _vm._ssrNode(" <div class=\"description\" data-v-24c4718f>" + _vm._s(_vm.pageDescription) + "</div> "), _vm._ssrNode("<div class=\"graphic\" data-v-24c4718f>", "</div>", [_c('LineChart', {
    attrs: {
      "id": "myChart0",
      "has-filters": true,
      "has-loader": true,
  ...
  })], 1), _vm._ssrNode(" "), _vm.youtubeLink ? _vm._ssrNode("<div class=\"other-contents\" data-v-24c4718f>", "</div>", [_c('YoutubeVideo', {
    attrs: {
...
// CONCATENATED MODULE: ./pages/index/NitrousoxidePage.vue?vue&type=template&id=24c4718f&scoped=true&
...
var useGlobalwarmingAPI = __webpack_require__(122);
...
/* harmony default export */ var NitrousoxidePagevue_type_script_lang_js_ = ({
  ...
  setup(props) {
    ...
    const {
      ...
      isPending,
      fetchWarmingData
    } = Object(useGlobalwarmingAPI["a" /* default */])({
